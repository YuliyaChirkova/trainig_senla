...
public class ServiceDataPage {
    public SelenideElement marriageDataRegistration =$(byXpath("//label[text()='Дата регистрации']/following::input[1]"));
    public SelenideElement spouseNewLastName =$(byXpath("//label[text()='Новая фамилия']/following::input[1]"));
    public SelenideElement spouseLastName =$(byXpath("//label[text()='Фамилия супруга/и']/following::input[1]"));
    public SelenideElement spouseFirstName =$(byXpath("//label[text()='Имя супруга/и']/following::input[1]"));
    public SelenideElement spouseMiddleName =$(byXpath("//label[text()='Отчество супруга/и']/following::input[1]"));
    public SelenideElement spouseBirthDate =$(byXpath("//label[text()='Дата рождения супруга/и']/following::input[1]"));
    public SelenideElement spousePassportNumber =$(byXpath("//label[text()='Номер паспорта супруга/и']/following::input[1]"));
    public SelenideElement finishButton =$(byXpath("//button [text()='Завершить']"));
    public SelenideElement birthPlace =$(byXpath("//label[text()='Место рождения']/following::input[1]"));
    public SelenideElement motherName =$(byXpath("//label[text()='Мать']/following::input[1]"));
    public SelenideElement fatherName =$(byXpath("//label[text()='Отец']/following::input[1]"));
    public SelenideElement deathPlace =$(byXpath("//label[text()='Место смерти']/following::input[1]"));
    public SelenideElement deathDate =$(byXpath("//label[text()='Дата смерти']/following::input[1]"));
